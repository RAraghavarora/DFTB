...
def fit_model_dense(n_train, n_val, n_test, iX, iY, patience):
    ...
    testX1.shape = [testX1.shape[0], 12, 23, 1]
    testX2.shape = [testX2.shape[0], 4, 10, 1]
    ...
    hidden3 = Conv2D(
        16, kernel_size=[3, 6], activation='relu', padding='valid', use_bias=True
    )(hidden2)
    ...
    hidden5 = Conv2D(
        32, kernel_size=[2, 2], activation='relu', padding='valid', use_bias=True
    )(hidden4)
...
def plotting_results(model, testX, testy, n_train):
    # applying nn model
    ...
    out2 = open(
        '/Users/davinderkumar/Essentials/Thesis/code/cnn/new/%s/errors_test.dat'
        % n_train,
        'w',
    )
    out2.write(
    ...
    s = ' '.join(format_list1)
    ctest = open(
        '/Users/davinderkumar/Essentials/Thesis/code/cnn/new/%s/comp-test.dat'
        % n_train,
        'w',
    )
...
current_dir = '/Users/davinderkumar/Essentials/Thesis/code/cnn/new'
